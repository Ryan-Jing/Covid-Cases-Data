...
with open("Covid_Data.csv") as fr, open("Covid_Data_Updated.csv", "w", newline="") as fw:
    cr = csv.reader(fr)
    cw = csv.writer(fw)
...
df = pd.read_csv('Covid_Data.csv', usecols = ['Reported Date', 'Confirmed Positive', 'Deaths'], low_memory = True)
